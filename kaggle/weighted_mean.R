## code: https://www.kaggle.com/nigelcarpenter/hklee-lb-0-496-r-port/code
...
date_info <- fread('data/input/date_info.csv')
air_visit_data <- fread('data/input/air_visit_data.csv')
sample_submission <- fread('data/input/sample_submission.csv')
...
write.csv(sample_submission[, c('id', 'visitors')], file = 'pred_ini.csv', row.names = FALSE)
